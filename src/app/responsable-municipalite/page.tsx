...
import ConsulterReclamations from './components/ConsulterReclamations';
import GererPointsCollecte from './components/GererPointsCollecte';
import GererVehicule from './components/GererVehicule';
import GererTournees from './components/GererTournees';
import ConsulterRapports from './components/ConsulterRapports';
import EnvoyerNotification from './components/EnvoyerNotification';
import ModifierPointCollecte from './components/ModifierPointCollecte';
import ModifierVehicule from './components/ModifierVehicule';
import ModifierTournee from './components/ModifierTournee';
import ModifierNotification from './components/ModifierNotification';
